...
//		function removePngRecordFile(path:String,callback:Function):void;
		...
		function getPicFile(path:String,callback:Function,clearType:int,clearTime:int = 214783647):void;
		function removeAQuote(path:String):void;
		
		function getPackageFile(path:String,callback:Function,clearType:int,clearTime:int = 214783647):void;
